...
const PokemonInfo = ({ pokemonId, setSelectedPokemon }) => {
  ...
  return (
    <>
      <div
        id="current-pokemon-responsive-background"
      ...
      <div id="current-pokemon-container" className="container column center">
        ...
        <div id="current-pokemon-info" className={pokemonInfo ? null : "hide"}>
            ...
            ? pokemonDescription.flavor_text_entries.map(
                (flavor_texts, index) => (
                  <span
                    ...
                    key={index}
                  >
                    {flavor_texts.language.name == "en" &&
                    flavor_texts.version.name == "white-2"
          ...
          <div className="row center mt-[0.8em]">
            <div className="width-100 column center margin-5">
              ...
              >
                {pokemonInfo ? pokemonInfo.height : null}
              </div>
            </div>
            <div className="width-100 column center margin-5">
